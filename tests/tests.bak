...
class TestRut:
    ...
    def test_valid_rut_string_with_leading_zeros(self):
        """
        Test that a Rut object is correctly created with a valid RUT string containing
        leading zeros in the base.
        """
        rut = Rut("00001234-3")
    ...
    def test_format_rut_with_default_options(self):
        """
        Test that the formatear() method correctly formats a RUT string with default options.
        """
        rut = Rut("12345678-5")
